...
abstract class Formulario
{
     ...
     */
    protected function generaCamposFormulario(&$datos) //ESTA FUNCION HAY QUE HACERLA EN LAS SUBCLASES
    {
        return '';
    }
     ...
     *
     */
    protected function procesaFormulario(&$datos) //ESTA FUNCION HAY QUE HACERLA EN LAS SUBCLASES
    { 
